    ...
    public function about(){
        ...
        $data = [
            0 => [
                ...
                'position' => 'Репетитор по математике 1-11 классов, Основатель PERO',
    ...
    public function pricing(){
        ...
        $data = [
            1 => [
                ...
                'sub_title' => null,
                'description' => [' 1500тг/час в группе или 2000тг/час индивидуально', ' Курс длится 1-2-3 месяца (в зависимости интенсивности)', ' 2-3 раза в неделю (решается после пробного урока)', ' Пробный урок 30-40 минут (стоимость 1000тг. Обсуждается все вопросы)'],
            ],
            2 => [
                'id' => 2,
                'price' => '2500 тг/час',
                ...
                'description' => [' 2500тг/час в группе или 3000тг/час индивидуально', ' Курс длится 1-2-3 месяца (в зависимости интенсивности)', ' 2-3 раза в неделю (решается после пробного урока)', ' Пробный урок 30-40 минут (стоимость 1000тг. Обсуждается все вопросы)'],
            ],
            3 => [
                'id' => 3,
                'price' => '2000 тг/час',
