                ...
                <div class="col-lg-6">
                    <div class="about-us-content about-us-offset-right position-relative x-index-1 small-mt__40 tablet-mt__40">
                        <div class="section-title-wrap">
                            ...
                            <h4 class="mb-20 section-title">Готовы представить Вам гайды и консультацию по поступлению в топовые ВУЗы мира</h4>
                            <h5 class="mb-20 font-weight--light"><span class="text-size-lg font-weight-bold text-color-secondary">Pero </span> - анализируем, создаем, практикуем</h5>
